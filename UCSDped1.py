...
TestVideoFile[5] = range(4,90) + range(139,200)
TestVideoFile[6] = range(0,100) + range(109,200)
...
TestVideoFile[29] = range(0,15) + range(44,113)
TestVideoFile[30] = range(174,200)
TestVideoFile[31] = range(0,180)
TestVideoFile[32] = range(0,52) + range(64,115)
